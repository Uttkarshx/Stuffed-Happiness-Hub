...
const products = [
  ...
  {
    name: 'Mini Dinosaur Plush',
    price: 649,
    description: 'A fun dinosaur plush that sparks imagination and keeps little explorers smiling.',
    category: 'kids',
  ...
  },
  {
    ...
    price: 699,
    description: 'Gentle fabric and adorable design make this elephant a great bedtime companion.',
    category: 'kids',
  ...
  {
    name: 'Tiny Tiger Plush',
    price: 579,
    description: 'A playful tiger toy for active kids who love jungle adventures and cuddles.',
    category: 'kids',
  ...
  {
    name: 'Rainbow Duck Buddy',
    price: 529,
    description: 'Bright and colorful plush duck that brings joy to every kid room and play corner.',
    category: 'kids',
  ...
  {
    name: 'Happy Hippo Toy',
    price: 629,
    description: 'An adorable hippo toy designed for hugs, laughter, and cheerful play sessions.',
    category: 'kids',
  ...
  // Friends (8)
  {
    name: 'Funny Emoji Plush',
    price: 549,
    description: 'A cute and funny plush to gift your best friend and make them smile instantly.',
    category: 'friends',
  ...
  },
  {
    name: 'Lazy Sloth Toy',
    price: 679,
    description: 'A lovable sloth plush that captures chill vibes and makes every gift moment fun.',
    category: 'friends',
  ...
  {
    name: 'Coffee Date Plushie',
    price: 589,
    description: 'A quirky plush companion made for friends who enjoy long talks and coffee breaks.',
    category: 'friends',
